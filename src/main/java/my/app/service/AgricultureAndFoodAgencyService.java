...
@Service
public class AgricultureAndFoodAgencyService {
    private static final Logger logger = LoggerFactory.getLogger(AgricultureAndFoodAgencyService.class);
    private static final List<WeatherData> WEATHER_DATA_QUEUE = new ArrayList<>();
    private static final ObjectMapper mapper = new ObjectMapper();

    @KafkaListener(topics = { Topic.WEATHER }, groupId = WeatherGroup.AGRICULTURE_AND_FOOD_AGENCY)
